...
SCENARIOS = {
    "safe": {
        ...
        "leverage": 3,
        "risk_reward_ratio": 4.0,  # take‑profit twice the stop‑loss distance
        "max_positions": 1,
        "ema_fast": 50,
        "ema_slow": 200,
        "atr_period": 14,
    ...
    "risky": {
        "risk_percentage": 0.55,  # 55% of equity per trade
        "leverage": 10,
        ...
        "long_score_threshold": 4,
        "short_score_threshold": 4,
        "allow_long": True,
        "allow_short": True,
    },
}
